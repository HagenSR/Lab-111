...
import SourceCode.TableCreator;
...
public class GraphExamples {
    ...
    public static void main(String[] args) {
        ...
        //each block of code outputs its corresponding graph and table
        System.out.println("Figure 14.3");
        System.out.println(figure14_3());
        String[][] a = edgesToMatrix(figure14_3());
        TableCreator a1 = new TableCreator(a);
        

        System.out.println("Figure 14.8");
        System.out.println(figure14_8());
        String[][] b = edgesToMatrix(figure14_8());
        TableCreator b1 = new TableCreator(b);
        

        System.out.println("Figure 14.9");
        System.out.println(figure14_9());
        String[][] c = edgesToMatrix(figure14_9());
        TableCreator c1 = new TableCreator(c);
        

        System.out.println("Figure 14.11");
        System.out.println(figure14_11());
        String[][] d = edgesToMatrix(figure14_11());
        TableCreator d1 = new TableCreator(d);
        

        System.out.println("Figure 14.12");
        System.out.println(figure14_12());
        String[][] e = edgesToMatrix(figure14_12());
        TableCreator e1 = new TableCreator(e);
        

        System.out.println("Figure 14.14");
        System.out.println(figure14_14());
        String[][] f = edgesToMatrix(figure14_14());
        TableCreator f1 = new TableCreator(f);
        

        System.out.println("Figure 14.15");
        System.out.println(figure14_15());
        String[][] g = edgesToMatrix(figure14_9());
        TableCreator g1 = new TableCreator(g);
    ...
    /**
     * Takes a graph from one of the above methods and creates an adjacency matrix for use in the table creator method.
     * Works whether or not the graph is directional or not
     * @param graph A graph object 
     * @return a string array representing an adjacency matrix
     */
    public static String[][] edgesToMatrix(Graph<String, Integer> graph) {
        String[][] a = new String[graph.numVertices() + 1][graph.numVertices() + 1];
        Iterable<Vertex<String>> vertices = graph.vertices();
        Iterator<Vertex<String>> iterator = vertices.iterator();
        for (int x = 1; x < a.length; x++) {
            Vertex<String> temp = iterator.next();
            a[x][0] = temp.getElement();
            a[0][x] = temp.getElement();
        }
        Iterable<Vertex<String>> verts1 = graph.vertices();
        Iterator<Vertex<String>> iterator1 = verts1.iterator();
        for(int x = 1; x < a.length; x++){
            Vertex one = iterator1.next();
            Iterator<Vertex<String>> iterator2 = verts1.iterator();
            for(int y = 1; y < a[x].length; y++){
                Vertex two = iterator2.next();
                if(graph.getEdge(one, two) == null){
                    a[x][y] = "0";
                }
                else{
                a[x][y] = graph.getEdge(one, two).getElement().toString();
                }
            }
        }
